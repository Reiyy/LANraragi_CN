...
sub plugin_info {
    ...
    return (
        ...
        version     => "1.9",
        description => "在 nHentai 上搜索与你的档案匹配的标签。
          <br>支持从格式为 \"{Id} Title\" 的文件中读取ID，如果没有，尝试搜索匹配的画廊。
          <br><i class='fa fa-exclamation-circle'></i> 如果有，此插件将使用档案中的 source: 标签。",
        icon =>
        ...
        parameters  => [ { type => "bool", desc => "获取上传日期来添加时间戳标签" } ],
        oneshot_arg => "nHentai 画廊URL（将匹配该画廊的标签到档案）"
    );
