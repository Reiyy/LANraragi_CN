...
sub plugin_info {
    ...
    return (
        ...
        author      => "lily",
        version     => "0.2",
        description => "从 HentaiAtHome 下载器的 galleryinfo txt 文件中收集嵌入到你的档案中的元数",
        icon        =>
...
sub get_tags {
    ...
    die "No galleryinfo.txt file found in this archive!\n" if ( !$path_in_archive );
    ...
    die "No tags were found in galleryinfo.txt!\n";
}
